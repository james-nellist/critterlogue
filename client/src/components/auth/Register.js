...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('/api/auth/register/', formFieldsUpdated)
    ...
    <div className='register-form-container'>
      <div className="register-border">
        <form action="" onSubmit={handleSubmit}>
          ...
          <input type="text" name="profileImage" placeholder='profileImage' onChange={handleChange} value={formFields.profileImage} /> */}
          ...
          <input type="password" name="password_confirmation" placeholder='confirm password' onChange={handleChange} value={formFields.passwordConfirmation} />
